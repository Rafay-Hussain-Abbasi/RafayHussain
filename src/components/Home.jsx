...
import GithubSvg from "../assets/images/svg/github-svg.svg";
import InstagramSvg from "../assets/images/svg/intagram-svg.svg";
...
import clientImg1 from "../assets/images/htmlLogo.png";
import clientImg2 from "../assets/images/CssLogo.png";
import clientImg3 from "../assets/images/javascriptLogo.png";
import clientImg4 from "../assets/images/elementorLogo.png";
    ...
    <>
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          ...
          <h1 className="fade_up">
            Rafay <span>Hussain</span>
          </h1>
          <h2 className="designer fade_up">{firstTexts[firstTextIndex]}</h2>
          <div className="profile-media-icons-main fade_up">
            <Link to="mailto:rafay10sep@gmail.com" className="profile-media-icons">
              <img src={EmailSvg} alt="email-svg" />
            </Link>
            <Link to="https://www.linkedin.com/in/rafay-hussain-0a4b36205" className="profile-media-icons">
              <img width={23} src={LinkedinSvg} alt="linkedin-svg" />
            </Link>
            <Link to="https://github.com/Rafay-Hussain-Abbasi" className="profile-media-icons">
              <img width={23} src={GithubSvg} alt="github-svg" />
            </Link>
            <Link to="https://www.instagram.com/rafay.__.hussain" className="profile-media-icons">
              <img width={23} src={InstagramSvg} alt="insta-svg" />
            </Link>
          </div>
        </div>
        <div className="menu-list-main">
          <ul>
            ...
            <li
              className={`active-menu-action ${activeLink === "testimonial" ? "active" : ""
                }`}
            >
              <a
                className="fade_right"
              ...
              >
                <img width={20} src={Testimonial} alt="home-svg" />
                Testimonials
              </a>
            </li>
            <li
      ...
      <div className="main-containe" data-bs-spy="scroll">
          ...
          <div className="row">
            <div className="col-xxl-6 col-lg-6">
              ...
              <p className="best fade_down">
                "Bringing creativity and technical expertise together to craft stunning and user-friendly web experiences."
              </p>
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              <div className="worked-box">
                <p className="worked-more">Technologies that I have experienced with</p>
                <div className="client-img-main position-relative">
                  ...
                  <img
                    ...
                    alt="clients-img4"
                  />
                  <a href="#skills" className="worked-more worked-more2"> See More ↠</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="Marquee-main overflow-hidden">
          <h3 className="fade_up">Core Professional Competencies</h3>
